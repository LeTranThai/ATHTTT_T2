...
<jsp:useBean id="cart" scope="session" type="org.example.demo.model.Cart"/>
<jsp:useBean id="account" scope="session" type="org.example.demo.model.Account"/>
<!-- pages-title-end -->
                            ...
                            <div class="checkbox-form">
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="di-na bs">
                                        ...
                                        >
                                        <p class="form-error" style="color: red" id="name"></p>
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <div class="di-na bs">
                                        ...
                                        <input class="form-control" id="phone-number" type="tel" required="" name="sdt"
                                               ...
                                               value="${account.phone}">
                                        <p class="form-error" style="color: red" id="sdt"></p>
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <div class="di-na bs">
                                        ...
                                        <p class="form-error" style="color: red" id="add"></p>
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <div class="di-na bs">
                                        ...
                                        <div class="di-na bs">
                                            <input class="form-control" id="private" type="text" required=""
                                                   name="private"
                                        ...
                                        <p class="form-error" style="color: red" id="key"></p>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        paymentButton.addEventListener('click', function () {
            ...
            var address = document.getElementById('address-customer').value;
            var privateKey = document.getElementById('private').value;

            if (fullName.trim() === '') {
                document.getElementById("name").textContent = 'Họ tên không được để trống';
            }

            if (phoneNumber.trim() === '') {
                document.getElementById("sdt").textContent ='Số điện thoại không được để trống';
            }

            if (address.trim() === '') {
                document.getElementById("add").textContent ='Địa chỉ không được để trống';
            }

            if (privateKey.trim() === '') {
                document.getElementById("key").textContent ='Private key không được để trống';
            }
        });
    });
</script>
